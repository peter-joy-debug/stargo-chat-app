...
<>
                ...
                <Card style={{ width: '80%',padding:'2px', borderTopLeftRadius:'12px',borderTopRightRadius:'12px',marginLeft:'10%',backgroundColor:'lightgreen'}} className='back-two'>
                    <Container>
                        <Row>
                            <Col sm={12}>
                            
                            <span> here it is my message,ssh is the protocol being used for checking authentication</span><br></br>
                            <span style={{fontSize:'11px',marginBottom:'20px',padding:'1%',backgroundColor:'black',color:'whitesmoke',borderRadius:'5px'}} className="back-three"> 12:00 | sent by Me</span>
                            </Col>
